...
//import DAO from './contract/DAOweb3artifact.json';
import DAO from './DAOweb3.json';
...
function App() {
  ...
  useEffect(() => {
    const init = async () => {
      ...
      console.log(web3);
      //let [signerAddress, DAOcontract] = web3;
      // console.log('signerAddress, DAOcontract', signerAddress, DAOcontract);
      ...
      //DAO address: 0xe7f1725E7734CE288F8367e1Bb143E90bb3F0512
      ...
      // const contract = web3.DAOcontract;

      console.log('contract', contract.methods.admin);
